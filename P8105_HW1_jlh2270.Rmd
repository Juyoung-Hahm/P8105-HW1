...
There are `r nrow(penguins) * ncol(penguins)` data sets. After deleting the NA data, we now have `r nrow(penguins_new) * ncol(penguins_new)` data sets in `penguins_new`. 
